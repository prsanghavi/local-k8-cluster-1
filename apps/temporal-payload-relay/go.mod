module github.com/prsanghavi/local-k8-cluster-1/apps/temporal-payload-relay
...
require (
	...
	go.temporal.io/sdk/contrib/aws/s3driver v0.2.0 // indirect
	go.temporal.io/sdk/contrib/aws/s3driver/awssdkv2 v0.2.0 // indirect
